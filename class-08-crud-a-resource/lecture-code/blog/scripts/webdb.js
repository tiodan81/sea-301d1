...
webDB.setupTables = function () {
  html5sql.process(
    'CREATE TABLE articles(id INTEGER PRIMARY KEY, title VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, authorUrl VARCHAR(255), publishedOn DATE NOT NULL, body VARCHAR NOT NULL);',
    function() {
      // on success
